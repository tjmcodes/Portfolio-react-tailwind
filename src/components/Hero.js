  ...
  return (
    <div name="Hero" className="px-0 sm:px-12 w-full h-screen bg-dark">
      ...
      <h3 className="text-accent4 text-2xl flex ">Hi! &nbsp; <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" alt="wave" width="30"></img> &nbsp; <p className="text-accent4 text-2xl flex items-center">My name is</p> </h3></div>
        ...
        I'm committed to ongoing learning and improvement, updating my skills and knowledge. I achieve this by conducting research, creating new web applications, and refining my workflow for optimal efficiency.</p>
