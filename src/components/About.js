...
const About = () => {
  ...
  return (
    <div name="About" className="px-4 sm:px-12  w-full h-screen bg-dark pt-24 pb-24">

      {/* Container */}
      <div className="max-w-[1000px] mx-auto px-5 flex flex-col justify-center">
        <img src="https://readme-typing-svg.herokuapp.com?color=6341F7&lines=Junior+Software+Developer+;Based+in+the+UK+%F0%9F%87%AC%F0%9F%87%A7&left=true&&color=f75c7e&vCenter=true&size=12" alt="ticker" />
